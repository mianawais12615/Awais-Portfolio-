...
const SKILLS = [
  {
    ...
    items: ["React.js / Next.js", "HTML5 / CSS3", "Tailwind CSS", "JavaScript (ES6+)"]
  },
  {
    category: "Backend",
...
const PROJECTS = [
  {
    ...
    description: "A full-featured headless commerce solution with real-time inventory tracking, secure Stripe integration, and an ultra-fast customer checkout experience.",
    tags: ["React", "Node.js"],
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBkOmbmwK0lXO9Ug_RxvPHmTdWBvO-TmRW-jcMX6Y5aVYkGYPHcFxOVqSemOWJ81pFZ_BVLd1AsOd5aFevvt91hqApG1LIeItfZ7RG27Gl4E92KcsCu7lLRrzF4dMR2VqY29KOL6vK9kg4y9SJY64EszmptSdFEsRAVuRSYy7uDiwcD5Or3GKLHmYkrdit3odbMcrFdfbLpOiBCI0AzJD0Hpr0J9CWb0IxrvOHwbbbLlNhPn4PtuOrST-l1hTzuJhappPN3nq0Y0Q",
    large: true
  },
  {
    title: "SaaS Dashboard",
    description: "Advanced analytics platform with dynamic data visualization and user management systems.",
    tags: ["Next.js"],
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuC4VgB8R82ezCjKH19f-leLoehrdyuMS0KK-LJwtNczRU7txOeCD7wuKxMB9BwezTwmjal3EBp5TkY09JVTt5XdVR7dD-EKbLPuccMIyghpPb_vb4Ox2GXbEQ5foj3_AthuzKBSqg3lQ19uhLY9mDLMPEWwyXqJn5hmQqft0bhPz7oRfhUQUQppbSbGHXGI-AiFPMuYQ9KoyAEnD1DiLm2oI9GrinDY51tDJVZMG83XrKw0nkMw-q1T0DQm_3ehGRTmC-BfatWKvw",
    large: false
  },
  {
    title: "Nexus Social Platform",
    description: "A decentralized approach to social networking focusing on data privacy and real-time community interactions using WebSockets and end-to-end encryption.",
    tags: ["MongoDB", "Express"],
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAMh8iTf4A8v5E7STYMM1nqpNOqFh4JpEyW2tyyUaf3wsowVBUMfj_sEC9ZiiphQmXGJt2_wuGbEm6MH0yk_Oz5j10Vf-yP6CjBNp9V09ZcLa79HNgWdrxuQyuxnnD2FQg0lMvYnft9MKJpzPYgWjSI0AxpUVbtjR63hCnH6vKCtQ3s33P3mqWIjri9WzTytRSrdD_DmgbmkGtWhQfm03dv92ucka56erdIl09lnUkQOyezk2N8bF_kjw7XQ67Ke0VXDEki9FTXqg",
    large: true,
    row: true
  }
];
...
const TIMELINE = [
  {
    ...
    period: "2020 - 2021",
    description: "Founded my base in JavaScript and modern CSS. Assisted in delivering 5+ client landing pages and refined my debugging skills.",
  ...
  },
  {
    ...
    period: "2021 - 2023",
    description: "Took ownership of end-to-end features. Mastered the MERN stack and optimized database queries reducing latency by 40%.",
  ...
  },
  {
    ...
    period: "2023 - Present",
    description: "Leading a team of 4 developers. Architected a microservices-based SaaS platform serving 50k+ active monthly users.",
  ...
  return (
    <>
          ...
          >
            <div className="relative">
              ...
              <div className="flex justify-between items-end w-[200px] mb-2 text-primary font-headline">
                <span className="text-[10px] tracking-[0.4em] uppercase opacity-50">Initializing</span>
                <motion.span 
            ...
            >
              <div className="text-[2vw] font-headline font-bold uppercase tracking-tighter text-on-surface opacity-10">Awais Portfolio</div>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-12 gap-16 items-center relative z-10">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <span className="text-[10px] uppercase font-bold tracking-[0.5em] text-primary">Senior Full Stack Architect</span>
              </div>
              
              <h1 className="text-[clamp(4rem,10vw,8rem)] font-bold leading-[0.85] tracking-tighter">
                Logic <br /> <span className="text-gradient">Engineered.</span>
              </h1>

              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  <div className="px-2 py-0.5 border border-primary/20 bg-primary/5 rounded text-[10px] font-bold text-primary uppercase tracking-widest">Available for Hire</div>
                  <div className="text-[10px] text-on-surface-variant/60 font-medium uppercase tracking-widest">Based in Remote / Global</div>
                </div>
                
                <h2 className="text-2xl md:text-3xl font-medium text-on-surface-variant leading-tight max-w-xl">
                  Hi, I'm <span className="text-on-surface font-bold">Awais</span>. I build robust systems with <span className="italic text-on-surface">MERN</span> & <span className="underline decoration-primary/40 underline-offset-8">React</span>.
                </h2>
                
                <p className="text-lg text-on-surface-variant/70 max-w-lg leading-relaxed font-body">
                  Turning complex architectural challenges into high-performance, accessible digital experiences through clean code and tonal depth.
                </p>
              </div>
            ...
            >
              ...
              >
                ...
                <div className="text-[8px] uppercase tracking-[0.3em] font-bold text-on-surface-variant font-headline">Years of System Mastery</div>
              </motion.div>
            </motion.div>
          </div>
        </section>
        ...
        {/* About Section */}
        <section id="about" className="py-32 bg-surface-container-low px-6 relative">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-center">
            ...
            <motion.div 
              ...
              className="space-y-8"
            >
              <span className="text-xs uppercase tracking-[0.3em] font-bold text-primary">About Me</span>
              <h2 className="text-5xl font-bold leading-[1.1]">Engineering Excellence through Clean Architecture.</h2>
              <p className="text-on-surface-variant text-lg leading-relaxed">
                With four years of hands-on experience in the MERN stack, I've evolved from building simple interfaces to architecting complex distributed systems. My focus lies at the intersection of performance, accessibility, and clean code principles.
              </p>
              
              <div className="grid grid-cols-2 gap-12 pt-4">
                <div className="space-y-2">
                  <h4 className="text-4xl font-bold text-primary">20+</h4>
                  <p className="text-xs uppercase tracking-widest text-on-surface-variant font-medium">Projects Completed</p>
                </div>
                <div className="space-y-2">
                  <h4 className="text-4xl font-bold text-primary">100%</h4>
                  <p className="text-xs uppercase tracking-widest text-on-surface-variant font-medium">Client Satisfaction</p>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
              <div className="max-w-2xl space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-[10px] uppercase tracking-[0.4em] font-bold text-primary">Capabilities</span>
                </div>
                <h2 className="text-6xl md:text-7xl font-bold tracking-tighter">Stack & <br /> <span className="opacity-30">Strategy.</span></h2>
              </div>
              ...
              {SKILLS.map((skill, idx) => (
                ...
                >
                  <div className="flex items-center gap-4 mb-10">
                    ...
                    <h3 className="font-bold text-lg uppercase tracking-wider">{skill.category}</h3>
                  </div>
                  <ul className="space-y-5">
                    {skill.items.map((item, i) => (
                      <li key={i} className="flex items-center justify-between text-xs text-on-surface-variant font-medium group/item">
                        <span>{item}</span>
        ...
        <section className="py-32 bg-surface-container-low px-6 border-y border-outline-variant/5" id="work">
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-end mb-20">
              <h2 className="text-6xl font-bold">Selected Works</h2>
              <a href="#" className="text-primary hover:text-primary-container transition-colors font-bold text-sm uppercase tracking-widest flex items-center gap-2">
            ...
            <div className="grid md:grid-cols-12 gap-8">
              {PROJECTS.map((project, idx) => (
                ...
                >
                  <div className={`${project.row ? 'md:w-1/2' : ''} overflow-hidden aspect-video relative`}>
                    <img 
                      src={project.image} 
                      alt={project.title}
                      referrerPolicy="no-referrer"
                  ...
                  <div className={`p-10 ${project.row ? 'md:w-1/2 flex flex-col justify-center' : ''} space-y-6`}>
                    <div className="flex gap-2">
                      {project.tags.map(tag => (
                        <span key={tag} className="text-[10px] uppercase tracking-widest px-3 py-1 bg-surface-container-highest text-primary font-bold rounded">
                          {tag}
                        </span>
                      ))}
                    </div>
                    ...
                    <div className="flex gap-4 pt-4">
                      {project.large || project.row ? (
                        <>
                          <button className="btn-gradient text-[#00363f] px-6 py-3 rounded-md font-bold text-sm">Live Demo</button>
                          <button className="border border-outline-variant/20 px-6 py-3 rounded-md font-bold text-sm hover:bg-surface-container-high transition-colors">Source Code</button>
                        </>
                      ) : (
        ...
        <section className="py-40 px-6 relative" id="experience">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col items-center mb-32 space-y-6">
              <div className="px-4 py-1 rounded-full border border-primary/20 bg-primary/5 text-[10px] font-bold text-primary uppercase tracking-[0.4em]">The Progression</div>
              <h2 className="text-7xl font-bold tracking-tighter">Career Loop.</h2>
            </div>
            ...
            <div className="space-y-12 relative before:absolute before:left-0 md:before:left-1/2 before:w-[1px] before:h-full before:bg-outline-variant/20">
              {TIMELINE.map((item, idx) => (
                <div key={idx} className={`relative flex flex-col md:flex-row gap-12 ${idx % 2 !== 0 ? 'md:flex-row-reverse' : ''}`}>
                  <div className={`md:w-1/2 ${idx % 2 === 0 ? 'md:text-right' : 'md:text-left'} space-y-2`}>
                    <motion.div
                    ...
                    >
                      ...
                      <p className="text-primary font-bold">{item.company} | <span className="text-on-surface-variant font-medium">{item.period}</span></p>
        ...
        {/* Contact Section */}
        <section className="py-32 bg-surface-container-low px-6 transition-colors" id="contact">
          <div className="max-w-7xl mx-auto">
            <div className="bg-surface-container-high rounded-3xl overflow-hidden border border-outline-variant/10 flex flex-col lg:flex-row">
              <div className="lg:w-1/2 p-12 lg:p-20 space-y-10 bg-surface-container-highest/20">
                <div className="space-y-6">
                  <h2 className="text-6xl font-bold leading-tight">Let's build something <span className="text-gradient">remarkable.</span></h2>
                ...
                <div className="space-y-8">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="font-headline font-semibold text-lg">hello@awais.dev</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="font-headline font-semibold text-lg">Remote / Worldwide</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <form className="space-y-10">
                  <div className="space-y-10 overflow-hidden">
                    <div className="relative group">
                      ...
                      />
                      <label className="absolute left-0 top-4 text-on-surface-variant pointer-events-none transition-all peer-focus:-top-4 peer-focus:text-xs peer-focus:text-primary peer-[:not(:placeholder-shown)]:-top-4 peer-[:not(:placeholder-shown)]:text-xs">Your Name</label>
                    </div>
                    ...
                    <div className="relative group">
                      <input 
                        ...
                        className="w-full bg-transparent border-b border-outline-variant/30 py-4 focus:ring-0 focus:border-primary transition-colors text-on-surface placeholder:text-transparent peer"
                      />
                      <label className="absolute left-0 top-4 text-on-surface-variant pointer-events-none transition-all peer-focus:-top-4 peer-focus:text-xs peer-focus:text-primary peer-[:not(:placeholder-shown)]:-top-4 peer-[:not(:placeholder-shown)]:text-xs">Your Email</label>
                    </div>
                    ...
                    <div className="relative group">
                      ...
                      />
                      <label className="absolute left-0 top-4 text-on-surface-variant pointer-events-none transition-all peer-focus:-top-4 peer-focus:text-xs peer-focus:text-primary peer-[:not(:placeholder-shown)]:-top-4 peer-[:not(:placeholder-shown)]:text-xs">Your Message</label>
                    </div>
                  </div>
                  
                  <button type="submit" className="w-full btn-gradient text-[#00363f] py-5 rounded-xl font-bold text-lg hover:scale-[0.99] active:scale-[0.97] transition-transform">
                    Send Message
                  </button>
                </form>
              </div>
      ...
      <footer className="py-12 px-6 border-t border-outline-variant/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-2xl font-bold font-headline uppercase tracking-tighter text-on-surface">Awais</div>
          ...
          <div className="flex gap-12">
            {[
              ...
              <a key={i} href={social.href} className="text-on-surface-variant/40 hover:text-primary transition-colors hover:scale-110 transform">
                {social.icon}
              </a>
            ))}
          </div>
